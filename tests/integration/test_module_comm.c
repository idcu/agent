...
static int test_sender_init(void) { return IDCU_ERR_SUCCESS; }
...
static int test_sender_run(void) {
    ...
    int ret = idcu_msg_send(g_comm_data.bus, g_comm_data.sender_id, g_comm_data.receiver_id,
                            IDCU_MSG_PRIO_NORMAL, &ctx);
    return ret;
}

static int test_sender_stop(void) { return IDCU_ERR_SUCCESS; }
...
static int test_receiver_stop(void) { return IDCU_ERR_SUCCESS; }

static const idcu_ModuleInterface g_test_sender = {.name = "test_sender",
                                                   .dependencies = NULL,
                                                   .dependency_count = 0,
...
static const idcu_ModuleInterface g_test_receiver = {.name = "test_receiver",
                                                     .dependencies = NULL,
                                                     .dependency_count = 0,
...
static void test_real_module_communication(void) {
    ...
    const idcu_RegisteredModule *sender_mod =
        idcu_module_registry_find_by_name(&reg, "test_sender");
    const idcu_RegisteredModule *receiver_mod =
        idcu_module_registry_find_by_name(&reg, "test_receiver");
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "message_send_between_modules",
                             test_message_send_between_modules);

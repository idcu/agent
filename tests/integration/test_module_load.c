...
static const idcu_ModuleDependency g_module_b_deps[] = {{"test_module_a"}};

static const idcu_ModuleDependency g_module_c_deps[] = {{"test_module_a"}, {"test_module_b"}};

static const idcu_ModuleInterface g_test_module_a = {.name = "test_module_a",
                                                     .dependencies = NULL,
                                                     .dependency_count = 0,
...
static const idcu_ModuleInterface g_test_module_b = {.name = "test_module_b",
...
static const idcu_ModuleInterface g_test_module_c = {.name = "test_module_c",
...
static void test_module_dependency_circular(void) {
    ...
    idcu_ModuleInterface circular_a = {.name = "circular_a",
    ...
    idcu_ModuleInterface circular_b = {.name = "circular_b",
    ...
    ret = idcu_module_registry_topological_sort(&reg);
    IDCU_TEST_ASSERT(ret == IDCU_ERR_CIRCULAR_DEP,
                     "topological_sort should detect circular dependency");
...
static void test_module_missing_dependency(void) {
    ...
    idcu_ModuleInterface module_with_missing_dep = {.name = "module_with_missing_dep",
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_NOT_FOUND,
                     "build_dependency_graph should detect missing dependency");
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "module_dependency_graph_build",
                             test_module_dependency_graph_build);
    ...
    idcu_test_suite_add_test(&g_suite, "module_dependency_circular",
                             test_module_dependency_circular);

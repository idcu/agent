...
static const idcu_ModuleInterface g_flaky_module = {.name = "flaky_module",
                                                    .dependencies = NULL,
                                                    .dependency_count = 0,
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "health_module_registration",
                             test_health_module_registration);

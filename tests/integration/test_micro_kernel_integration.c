...
static const idcu_ModuleInterface g_test_mod1 = {.name = "test_mod1",
                                                 .dependencies = NULL,
                                                 .dependency_count = 0,
                                                 .init = test_mod1_init,
                                                 .run = test_mod1_run,
...
static const idcu_ModuleInterface g_test_mod2 = {.name = "test_mod2",
                                                 .dependencies = NULL,
                                                 .dependency_count = 0,
                                                 .init = test_mod2_init,
                                                 .run = test_mod2_run,
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "micro_kernel_module_lifecycle",
                             test_micro_kernel_module_lifecycle);
    idcu_test_suite_add_test(&g_suite, "micro_kernel_signal_handler_setup",
                             test_micro_kernel_signal_handler_setup);
    idcu_test_suite_add_test(&g_suite, "micro_kernel_with_registry",
                             test_micro_kernel_with_registry);
    idcu_test_suite_add_test(&g_suite, "micro_kernel_sandbox_setup",
                             test_micro_kernel_sandbox_setup);

...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "distributed_node_init_destroy",
                             test_distributed_node_init_destroy);
    idcu_test_suite_add_test(&g_suite, "distributed_node_add_remove",
                             test_distributed_node_add_remove);
    idcu_test_suite_add_test(&g_suite, "distributed_node_find", test_distributed_node_find);
    idcu_test_suite_add_test(&g_suite, "distributed_node_status_update",
                             test_distributed_node_status_update);
    idcu_test_suite_add_test(&g_suite, "distributed_node_message_queue",
                             test_distributed_node_message_queue);

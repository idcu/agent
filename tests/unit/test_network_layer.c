...
static void test_network_udp_sendto_recvfrom(void) {
    ...
    ret = idcu_network_socket_sendto(&sock2, test_msg, strlen(test_msg), "127.0.0.1", port1, &sent);
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "network_socket_create_destroy",
                             test_network_socket_create_destroy);
    idcu_test_suite_add_test(&g_suite, "network_server_create_destroy",
                             test_network_server_create_destroy);
    ...
    idcu_test_suite_add_test(&g_suite, "network_udp_sendto_recvfrom",
                             test_network_udp_sendto_recvfrom);

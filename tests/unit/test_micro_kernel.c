...
static const idcu_ModuleInterface g_test_iface1 = {.name = "test_module1",
                                                   .dependencies = NULL,
                                                   .dependency_count = 0,
...
static const idcu_ModuleInterface g_test_iface2 = {.name = "test_module2",
                                                   .dependencies = NULL,
                                                   .dependency_count = 0,
...
static void test_kernel_stop(void) {
    ...
    IDCU_TEST_ASSERT(k.tracked_modules[0].state == IDCU_MOD_STATE_STOPPED,
                     "Module 0 should be stopped");
    IDCU_TEST_ASSERT(k.tracked_modules[1].state == IDCU_MOD_STATE_STOPPED,
                     "Module 1 should be stopped");
...
static void test_kernel_tracked_modules(void) {
    ...
    IDCU_TEST_ASSERT(k.tracked_modules[0].state == IDCU_MOD_STATE_RUNNING,
                     "Module 0 should be running");
    IDCU_TEST_ASSERT(k.tracked_modules[1].state == IDCU_MOD_STATE_RUNNING,
                     "Module 1 should be running");
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "kernel_start_stop_lifecycle",

...
static void test_sandbox_init_destroy(void) {
    ...
    IDCU_TEST_ASSERT(sb.perm == (IDCU_PERM_SEND | IDCU_PERM_RECV),
                     "Permissions should be SEND|RECV");
...
static void test_sandbox_perm_check_null_param(void) {
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_INVALID_PARAM,
                     "idcu_sandbox_perm_check with NULL should fail");
    IDCU_TEST_PASS();
}
...
static void test_sandbox_add_perm(void) {
    ...
    IDCU_TEST_ASSERT(sb.perm == (IDCU_PERM_SEND | IDCU_PERM_RECV | IDCU_PERM_RUN),
                     "Permissions should be SEND|RECV|RUN");
...
static void test_sandbox_remove_perm(void) {
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_PERM_DENIED,
                     "Should not have PERM_RUN permission after removal");
...
static void test_sandbox_remove_perm_null_param(void) {
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_INVALID_PARAM,
                     "idcu_sandbox_remove_perm with NULL should fail");
    IDCU_TEST_PASS();
}
...
static void test_sandbox_get_perm(void) {
    ...
    IDCU_TEST_ASSERT(perm == (IDCU_PERM_SEND | IDCU_PERM_FILE),
                     "get_perm should return correct permissions");
...
static void test_sandbox_registry_init_destroy(void) {
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_OK,
                     "idcu_sandbox_registry_init should succeed when already initialized");
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "sandbox_set_quota_null_param",
                             test_sandbox_set_quota_null_param);
    idcu_test_suite_add_test(&g_suite, "sandbox_all_permissions", test_sandbox_all_permissions);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_init_destroy",
                             test_sandbox_registry_init_destroy);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_add_remove",
                             test_sandbox_registry_add_remove);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_add_null_param",
                             test_sandbox_registry_add_null_param);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_add_without_init",
                             test_sandbox_registry_add_without_init);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_get", test_sandbox_registry_get);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_get_without_init",
                             test_sandbox_registry_get_without_init);
    idcu_test_suite_add_test(&g_suite, "sandbox_registry_check_perm",

...
static void test_dynamic_loader_load_no_interface(void) {
    ...
    IDCU_TEST_ASSERT(ret == IDCU_ERR_MODULE_INVALID,
                     "Loading module without interface should return MODULE_INVALID");
...
int main(void) {
    ...
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_init_destroy",
                             test_dynamic_loader_init_destroy);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_empty_count",
                             test_dynamic_loader_empty_count);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_find_nonexistent",
                             test_dynamic_loader_find_nonexistent);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_get_at_invalid",
                             test_dynamic_loader_get_at_invalid);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_load_invalid_path",
                             test_dynamic_loader_load_invalid_path);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_null_params",
                             test_dynamic_loader_null_params);
    idcu_test_suite_add_test(&g_suite, "hotplug_null_params", test_hotplug_null_params);
    idcu_test_suite_add_test(&g_suite, "hotplug_valid_loader_null_params",
                             test_hotplug_valid_loader_null_params);
    idcu_test_suite_add_test(&g_suite, "hotplug_restart_nonexistent",
                             test_hotplug_restart_nonexistent);
    idcu_test_suite_add_test(&g_suite, "hotplug_unload_nonexistent",
                             test_hotplug_unload_nonexistent);

    idcu_test_suite_add_test(&g_suite, "dynamic_loader_load_good_module",
                             test_dynamic_loader_load_good_module);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_module_lifecycle",
                             test_dynamic_loader_module_lifecycle);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_load_duplicate",
                             test_dynamic_loader_load_duplicate);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_load_no_interface",
                             test_dynamic_loader_load_no_interface);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_module_init_fail",
                             test_dynamic_loader_module_init_fail);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_hotplug_load",
                             test_dynamic_loader_hotplug_load);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_restart_module",
                             test_dynamic_loader_restart_module);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_reload_module",
                             test_dynamic_loader_reload_module);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_unload_unloaded",
                             test_dynamic_loader_unload_unloaded);
    idcu_test_suite_add_test(&g_suite, "dynamic_loader_max_modules",
                             test_dynamic_loader_max_modules);

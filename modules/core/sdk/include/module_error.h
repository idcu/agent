...
extern "C"
{
    ...
    typedef void (*idcu_ModuleErrorHandler)(idcu_ModuleErrorContext* ctx,
                                            const idcu_ModuleError* error, void* user_data);
    ...
    void idcu_module_error_set_handler(idcu_ModuleErrorContext* ctx,
                                       idcu_ModuleErrorHandler handler, void* user_data);

    int idcu_module_error_raise(idcu_ModuleErrorContext* ctx, int error_code,

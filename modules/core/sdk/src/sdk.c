...
int idcu_sdk_broadcast_message(idcu_SdkContext *ctx, idcu_MsgPriority priority, const uint8_t *data,
                               uint32_t size) {
    (void)data;
    (void)size;
...
void idcu_sdk_set_message_bus(idcu_MessageBus *bus) { g_msg_bus = bus; }

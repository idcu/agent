...
int idcu_log_integration_init(idcu_LogIntegration* integration,
                                const char* log_file,
                                idcu_LogLevel level)
{
    if (!integration) {
...
static int log_integration_module_run(void)
{
    return 0;
}
...
IDCU_REGISTER_MODULE(log_integration, IDCU_MODULE_VERSION(1, 0, 0), 
                      log_integration_module_init, 
                      log_integration_module_run, 
                      log_integration_module_stop);

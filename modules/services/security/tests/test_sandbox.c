...
static void test_sandbox_perm_check_null_param(void) {
    ...
    if (ret != IDCU_ERR_INVALID_PARAM) {
        printf("test_sandbox_perm_check_null_param: FAIL - idcu_sandbox_perm_check with NULL "
               "should fail\n");
        return;
    }
...
static void test_sandbox_set_perm_null_param(void) {
    ...
    if (ret != IDCU_ERR_INVALID_PARAM) {
        printf("test_sandbox_set_perm_null_param: FAIL - idcu_sandbox_set_perm with NULL should "
               "fail\n");
        return;
    }
...
static void test_sandbox_add_perm_null_param(void) {
    ...
    if (ret != IDCU_ERR_INVALID_PARAM) {
        printf("test_sandbox_add_perm_null_param: FAIL - idcu_sandbox_add_perm with NULL should "
               "fail\n");
        return;
    }
...
static void test_sandbox_remove_perm(void) {
    ...
    if (ret != IDCU_ERR_PERM_DENIED) {
        printf(
            "test_sandbox_remove_perm: FAIL - Should not have PERM_RUN permission after removal\n");
        idcu_sandbox_destroy(&sb);
        return;
    }
...
static void test_sandbox_remove_perm_null_param(void) {
    ...
    if (ret != IDCU_ERR_INVALID_PARAM) {
        printf("test_sandbox_remove_perm_null_param: FAIL - idcu_sandbox_remove_perm with NULL "
               "should fail\n");
        return;
    }
...
static void test_sandbox_set_quota_null_param(void) {
    ...
    if (ret != IDCU_ERR_INVALID_PARAM) {
        printf("test_sandbox_set_quota_null_param: FAIL - idcu_sandbox_set_quota with NULL should "
               "fail\n");
        return;
    }
...
static void test_sandbox_registry_init_destroy(void) {
    ...
    if (ret != IDCU_ERR_OK) {
        printf("test_sandbox_registry_init_destroy: FAIL - idcu_sandbox_registry_init should "
               "succeed\n");
        return;
    }
    ...
    if (ret != IDCU_ERR_OK) {
        printf("test_sandbox_registry_init_destroy: FAIL - idcu_sandbox_registry_init should "
               "succeed when already initialized\n");
...
static void test_sandbox_registry_add_remove(void) {
    ...
    if (ret != IDCU_ERR_NOT_FOUND) {
        printf(
            "test_sandbox_registry_add_remove: FAIL - Remove non-existent sandbox should fail\n");
        idcu_sandbox_registry_destroy();
        idcu_sandbox_destroy(&sb1);
        idcu_sandbox_destroy(&sb2);
        return;
...
static void test_sandbox_registry_add_without_init(void) {
    ...
    if (ret != IDCU_ERR_NOT_INITIALIZED) {
        printf("test_sandbox_registry_add_without_init: FAIL - Add sandbox without init should "
               "fail\n");
        idcu_sandbox_destroy(&sb);
        return;
    }
...
static void test_sandbox_registry_get_without_init(void) {
    ...
    if (sb != NULL) {
        printf("test_sandbox_registry_get_without_init: FAIL - Get sandbox without init should "
               "return NULL\n");
        return;
    }
...
static void test_sandbox_registry_check_perm(void) {
    ...
    if (ret != IDCU_ERR_OK) {
        printf("test_sandbox_registry_check_perm: FAIL - Check perm SEND for module 100 should "
               "succeed\n");
        idcu_sandbox_registry_destroy();
        idcu_sandbox_destroy(&sb1);
        idcu_sandbox_destroy(&sb2);
    ...
    if (ret != IDCU_ERR_PERM_DENIED) {
        printf(
            "test_sandbox_registry_check_perm: FAIL - Check perm RUN for module 100 should fail\n");
        idcu_sandbox_registry_destroy();
        idcu_sandbox_destroy(&sb1);
        idcu_sandbox_destroy(&sb2);
        return;
    ...
    if (ret != IDCU_ERR_OK) {
        printf("test_sandbox_registry_check_perm: FAIL - Check perm RUN for module 200 should "
               "succeed\n");
        idcu_sandbox_registry_destroy();
        idcu_sandbox_destroy(&sb1);
        idcu_sandbox_destroy(&sb2);
    ...
    if (ret != IDCU_ERR_NOT_FOUND) {
        printf("test_sandbox_registry_check_perm: FAIL - Check perm for non-existent module should "
               "fail\n");
        idcu_sandbox_registry_destroy();
        idcu_sandbox_destroy(&sb1);
        idcu_sandbox_destroy(&sb2);

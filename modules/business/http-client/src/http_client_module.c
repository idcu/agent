...
static int http_client_module_run() { return 0; }
...
IDCU_REGISTER_MODULE(http_client_module, IDCU_MODULE_VERSION(1, 0, 0), http_client_module_init,
                     http_client_module_run, http_client_module_stop);

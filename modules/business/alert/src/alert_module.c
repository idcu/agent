...
static int alert_module_init() {
    ...
    const char *url =
        idcu_config_get_string(config_prefix, "notification_url", "http://localhost:8080/alert");
...
IDCU_REGISTER_MODULE(alert_module, IDCU_MODULE_VERSION(2, 0, 0), alert_module_init,
                     alert_module_run, alert_module_stop);

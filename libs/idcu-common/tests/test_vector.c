...
int main(void) {
    ...
    if (test_vector_init_destroy() != 0) failures++;
    if (test_vector_push_back() != 0) failures++;
    if (test_vector_get_set() != 0) failures++;
    if (test_vector_pop_back() != 0) failures++;
    if (test_vector_insert_remove() != 0) failures++;
    if (test_vector_clear() != 0) failures++;

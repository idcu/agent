...
int main(void) {
    ...
    if (test_hash_map_init_destroy() != 0)
        failures++;
    if (test_hash_map_insert_get() != 0)
        failures++;
    if (test_hash_map_contains() != 0)
        failures++;
    if (test_hash_map_remove() != 0)
        failures++;
    if (test_hash_map_clear() != 0)
        failures++;
    if (test_hash_map_multiple_inserts() != 0)
        failures++;

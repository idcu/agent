...
/**
 * @file error_code.h
 * @brief Unified error code definitions
 *
 * This file defines the unified error codes for IDCU Agent system.
 * All modules should use the error codes defined here for error handling.
 */
...
typedef enum
{
    ...
    // ========================================
    // Extended errors (new additions, backward compatible)
    // ========================================
    IDCU_ERR_TIMEOUT              = -32,
...
#define IDCU_ERROR_CONTEXT_MAX_LEN 256  // NOLINT(cppcoreguidelines-macro-to-enum,modernize-macro-to-enum)

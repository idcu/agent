...
int32_t idcu_atomic_load_int32(volatile int32_t *ptr) { return __sync_fetch_and_add(ptr, 0); }

void idcu_atomic_store_int32(volatile int32_t *ptr, int32_t value) {
    __sync_lock_test_and_set(ptr, value);
}

int32_t idcu_atomic_inc_int32(volatile int32_t *ptr) { return __sync_fetch_and_add(ptr, 1); }

int32_t idcu_atomic_dec_int32(volatile int32_t *ptr) { return __sync_fetch_and_sub(ptr, 1); }
...
int64_t idcu_atomic_load_int64(volatile int64_t *ptr) { return __sync_fetch_and_add(ptr, 0); }

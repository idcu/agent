...
typedef void (*idcu_DeviceDataCallback)(const char* device_name, const idcu_DeviceDataPoint* data, void* user_data);
typedef void (*idcu_DeviceStatusCallback)(const char* device_name, idcu_DeviceStatus status, void* user_data);

...
int main(void) {
    ...
    if (test_permission_init_shutdown() != 0) failures++;
    if (test_permission_grant_check() != 0) failures++;
    if (test_permission_revoke() != 0) failures++;
    if (test_permission_check_any_all() != 0) failures++;

...
extern "C"
{
    ...
    typedef void (*idcu_HealthCallback)(uint32_t module_id, idcu_HealthStatus old_status,
...
#define IDCU_MAX_MODULES_HEALTH 64
    ...
    void              idcu_health_set_thresholds(idcu_HealthMonitor* monitor, uint64_t timeout_ms,
    ...
    const idcu_ModuleHealth* idcu_health_get_all_modules(idcu_HealthMonitor* monitor,
                                                         uint32_t*           count);
